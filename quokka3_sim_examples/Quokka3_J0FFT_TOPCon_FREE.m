...
%
% this file excludes luminescence modeling for compatibility with the free version of Quokka3
...
Solver.SolutionType = 'single JV-point';
Solver.SingleJVPoint.Type = 'OC';
...
Optical.TextZ.FrontZ.Type = 'user';
Optical.TextZ.FrontZ.User.Type = 'const';
Optical.TextZ.FrontZ.User.Const = 1;
